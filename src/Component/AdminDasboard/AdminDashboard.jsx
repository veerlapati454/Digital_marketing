    ...
    <div className="ad-layout">
      ...
      <aside className={`ad-sidebar ${sidebarOpen ? "ad-sidebar--open" : ""}`}>
        ...
        <div className="sidebar-user">
          ...
          <button className="sidebar-logout" title="Sign out" onClick={()=>navigate("/login")}><FaSignOutAlt /></button>
        </div>
      </aside>
      ...
      <main className="ad-main">
        ...
        <header className="ad-topbar">
          ...
          <div className="topbar-actions">
            ...
            <div className="topbar-avatar" title="Profile">SA</div>
          </div>
        </header>
        ...
        <div className="ad-page">
          ...
          <div className="ad-page-header">
            ...
            <button className="primary-btn-ad">
          ...
          <div className="ad-mid-grid">
            ...
            <div className="ad-card ad-card--wide">
              <div className="card-header">
                <h3>Recent Users</h3>
                <button className="card-action">View All <FaArrowRight /></button>
              </div>
            ...
            <div className="ad-card">
              <div className="card-header">
                ...
                <button className="card-action">Clear</button>
              </div>
          ...
          <div className="ad-bottom-grid">
            ...
            <div className="ad-card">
              <div className="card-header">
                ...
                <button className="card-action">+ Add Role</button>
              </div>
            ...
            <div className="ad-card">
              <div className="card-header">
                <h3>Server Status</h3>
                <button className="card-action"><FaSync /> Refresh</button>
              </div>
